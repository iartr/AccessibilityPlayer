...
public class EFramebufferObject {
    ...
    public boolean equals(Object o) {
        ...
        EFramebufferObject that = (EFramebufferObject) o;
        return width == that.width && height == that.height && framebufferName == that.framebufferName && renderbufferName == that.renderbufferName && texName == that.texName;
    }

    @Override
    public int hashCode() {
        return Objects.hash(width, height, framebufferName, renderbufferName, texName);
    }
}
